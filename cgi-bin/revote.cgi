...
try:
    ...
    if len(form) != 0:
        ...
        subprocess.check_output(
            [PATH_TO_MACHINE, 'revote', C['id'].value, str(convert_date_to_id(ids[0])), unique_office_id, unqiue_candidate_id])
        #Delete cookie
        print('<b>Sucessfully cast ballot.</b><script>document.cookie = \"id=0;expires=Thu, 01 Jan 1970 00:00:01 GMT\";</script>')
        print('<ul>')
